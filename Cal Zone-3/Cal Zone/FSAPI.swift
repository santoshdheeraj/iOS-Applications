...
class FSAPI
{
    ...
    static let sharedInstance = FSAPI()
    var session:Session?
    ...
    init()
    {
        ...
        let client = Client(clientID: "ETYXNH455K2BB2Q3PYZIHEUUJASFAAXL15RHR2UDEYTOEKBL", clientSecret: "V0VCK1PZSJDM2A0CNPIWSNIR4O3MWFS0RYRK132UYVI4KMGQ", redirectURL: "")
    ...
    func getRestaurantsWithLocation(location:CLLocation)
    {
